...
urlpatterns = [
    ...
    path("cursos/<int:curso_id>/visualizar-curso", views.visualizacion_curso, name="visualizar-curso"),
    ...
    path('cambio_docente/<int:clase_id>/', views.cambio_docente, name='cambio_docente'),
