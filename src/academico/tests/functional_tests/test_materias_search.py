...
class MateriasTestCase(SeleniumTestCase):
    ...
    def test_filtrado_positivo_lista_Vacia(self):
        ...
        #Llenar form para filrado
        self.search.send_keys("Departamento 3")
        ...
        # Validar que se redirigió a la página de inicio
        self.assertEqual(
            self.selenium.current_url, self.live_server_url + "/academico/materias?q=Departamento+3"
        )
        self.assertNotIn("Departamento 2", self.selenium.page_source)
        self.assertNotIn("Departamento 1", self.selenium.page_source)
    ...
    def test_filtrado_positivo_no_filtrada(self):
        ...
        self.assertIn("Departamento 2", self.selenium.page_source)
        self.assertIn("Departamento 1", self.selenium.page_source)